...
// 10k rows from your business layer (generated by the docs mock here)
...
- 10k rows in the browser take the `worker + Workbook` path: responsive main thread, full styling;
...
Try it live in the [playground](/en/playground) with the sales dataset.
