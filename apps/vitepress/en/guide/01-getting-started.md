...
- Learn how [auto mode routing](/en/packages/excel-exporter/guide/03-auto-mode) picks main / worker / stream
- Try different modes and row counts in the [playground](/en/playground)
