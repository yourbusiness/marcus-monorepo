import type { FormatSpec } from "@marcusok/excel-exporter";
...
export const mockDatasets: MockDataset[] = [sales, inventory, staff];
...
export function previewRows(
  ...
  return getDataset(key).rows(count, seed).slice(0, count);
}
