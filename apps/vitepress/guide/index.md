...
| 包                                                      | 状态   | 说明                                                                         |
| ------------------------------------------------------- | ------ | ---------------------------------------------------------------------------- |
| [`@marcusok/excel-exporter`](/packages/excel-exporter/) | stable | Excel 导出核心库：WASM 驱动、完整样式、Worker 多线程、流式写入、SheetJS 兜底 |
...
新包发布后，只需在文档站 `apps/vitepress/.vitepress/registry.ts` 登记一条记录并补充对应文档，即可自动出现在本站在线文档中。
